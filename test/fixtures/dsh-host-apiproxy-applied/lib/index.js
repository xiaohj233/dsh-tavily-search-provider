...
const WEB_SETTINGS_NAMESPACES = [
	...
	"ui-theme",
	"web-search-deepseek",
	"keepalive", // dsh-keepalive: keep-alive watchdog configuration card (kept in sync by plugins/dsh-keepalive)
	"dsh-web-search-tavily" // dsh-web-search-tavily: Tavily settings card (replace-official-search switch)
];
